...
describe('Create Job Opportunity (end-to-end)', () => {
  ...
  test('should be able to create a Job Opportunity', async () => {
    ...
    const data: any = {
      ...
      nationality: 'Brazil',
      email: 'testcandidate1@email.com',
      phone: '(67) 98452-7351',
      address: 'test-address1',
      academicEducation: 'test-academic-education1',
      intendedSalary: '2.100',
      desiredJobTitle: 'test-desired-job-title1',
      companyName: 'test-company-name1',
      positionHeld: 'test-position-held1',
      companyContact: '(66) 93473-4839',
    }
  ...
  test('shoud be able to create a Job Opportunity without phone', async () => {
    const { jwt } = UserFactory.createAndAuthenticate()
