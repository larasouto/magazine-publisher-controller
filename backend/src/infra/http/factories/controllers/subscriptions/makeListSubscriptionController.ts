...
import { ListSubscriptions } from '@/application/subscriptions/use-cases/list-subscription/list-subscriptions'
import { ListSubscriptionsController } from '@/application/subscriptions/use-cases/list-subscription/list-subscriptions.controller'
...
export function makeListSubscriptionsController(): Controller {
  ...
  const useCaseListSubscription = new ListSubscriptions(prismaSubscriptionsRepository)
