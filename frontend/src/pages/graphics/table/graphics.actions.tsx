...
import { GraphicsColumns } from './graphics.columns'

type GraphicsActionsProps = {
  row: GraphicsColumns
}

export const GraphicsActions = ({ row }: GraphicsActionsProps) => {
        ...
        <DropdownMenu aria-label="dropdown reporter">
          <DropdownSection title={t('table.actions')}>
            <DropdownItem textValue="edit">
              <Link
                href={replaceParams(routes.graphics.edit, [row.id])}
                color="foreground"
