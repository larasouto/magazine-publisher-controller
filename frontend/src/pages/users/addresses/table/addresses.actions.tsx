...
import { AddressesColumns } from './addresses.columns'

type AddressesActionsProps = {
  row: AddressesColumns
}

export const AddressesActions = ({ row }: AddressesActionsProps) => {
        ...
        <DropdownMenu aria-label="dropdown reporter">
          <DropdownSection title={t('table.actions')}>
            <DropdownItem textValue="edit">
              <Link
                href={replaceParams(routes.profile.addresses.edit, [row.id])}
                color="foreground"
